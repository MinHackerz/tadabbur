...
export const DAILY_ANGLES: DailyAngle[] = [
  ...
  {
    day: 14,
    angleName: "Practical Life Application",
    angleType: "calligraphy",
    tag: "Living the Verse",
    timeMinutes: 5,
    prompt: "How can you practically apply the lessons of this verse in your daily life? Explore real-world scenarios, habits, and mindset shifts.",
    requiresApi: "chatgpt",
    cacheInDb: true,
  },
  {
